<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AtualizarAlbum.aspx.cs" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
        <h1 style="font-size:xx-large; font-family: Arial, Helvetica, sans-serif; font-weight: bolder; color: #000000;">Atualizar Album Existente </h1>
    </div>
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td style="height: 36px">
                <asp:Button ID="Button2" class="btn btn-primary btn-lg" runat="server" Font-Size="Large" OnClick="Button2_Click" Text="Atualizar" Width="150px" />
